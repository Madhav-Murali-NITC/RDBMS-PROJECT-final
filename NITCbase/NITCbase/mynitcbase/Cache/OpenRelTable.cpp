...
int OpenRelTable::closeRel(int relId) {
  ...
  while(current != NULL){
    ...
    if(temp->dirty==true){
      ...
      AttrCacheTable::attrCatEntryToRecord(&temp->attrCatEntry, &attrCatRecord);
      RecBuffer attrCatBlock(temp->recId.block);
      attrCatBlock.setRecord(&attrCatRecord, temp->recId.slot);
    }
